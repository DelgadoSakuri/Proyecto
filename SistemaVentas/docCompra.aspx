                        ...
                        <tr>
                            ...
                            <td colspan="2" style="vertical-align: top;" align="right">
                                <table border="1" style="height: 90px; font-weight: bold; ">
                                    ...
                                    <tr>
                                        <td align="center">NRO - <span id="numero"></span> </td>
                                    </tr>
                                    <tr>
                                        <td align="center">Fecha - <span id="fechacompra"></span> </td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="6">
                                <table style="width: 100%;">
                                    <tr bgcolor="#D9D9D9">
                                        <td colspan="4">
                                            <u>Detalle de Proveedor</u>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="15">Ruc:</td>
                                        <td style="border-bottom: 1px solid black;">
                                            <center><span id="rucproveedor"></span></center>
                                        </td>
                                        <td width="100">Razon Social:</td>
                                        <td style="border-bottom: 1px solid black;">
                                            <center><span id="nombreproveedor"></span></center>
                                        </td>
                                    </tr>
                                </table>
                                <hr>
                            ...
                            <td colspan="6">
                                <table style="width: 100%;" border="0">
                                    ...
                                    <tr>
                                        <td width="15">Ruc:</td>
                                        <td style="border-bottom: 1px solid black;">
                                            <center><span id="ructienda"></span></center>
                                        </td>
                                        <td width="110">Nombre Tienda:</td>
                                        <td style="border-bottom: 1px solid black;">
                                            <center><span id="nombretienda"></span></center>
                                        </td>
                                    </tr>
                                </table>
                            </td>
